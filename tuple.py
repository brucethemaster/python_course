...
# creating a tuple with a single element; DO NOT forget the comma
my_tuple = (9,)
...
print(my_tup[3])  # element 4


my_tup = ("a", "h", 32, 2.6, None, False)

print(my_tup[-5])  # element from last item to 5


my_tup = ("a", "h", 32, 2.6, None, False)

print(my_tup[::-1])  # reverse tuple


my_tuple = (101, [], 10.1, 1.01, 'Love', 'Python',
            'Java', 'C++', 'C#', 'SQL', 0, 0.1, (80,))

x = my_tuple[4::5]

print(x)  # start with element 4 and print
