...
"Cisco model: %s, %d WAN slots, IOS %.1f" % ('7200XR', 8, 15.4)
"Cisco model:{}, {} WAN slots, IOS {}".format('7200XR', 8, 15.4)
...
print(my_string[-11:-6])  # 90:00


my_string = "a0:12:90:00:80:43"

print(my_string.split(':'))  # split by delemeter
